...
public class MultiDArrayExample {
    public static void main(String[] args) {
        ...
        users[2][1] = "ParvinVienna123";

        String[][] usersData ={ {"Teodora Tsvetanov","TeodorasPWD12"},{"Anna Ziyayeva" ,"AnnaAlmaty123"},{"Parvin Altae","ParvinVienna123"}};
        System.out.println(usersData[0][0].split(" ")[0]);
