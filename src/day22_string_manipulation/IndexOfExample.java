...
public class IndexOfExample {
    public static void main(String[] args) {
        ...
        int indexCucumber = technologies.indexOf("cucumber");
        System.out.println("cucumber is at index " + indexCucumber);
        int indexSql = technologies.indexOf("sql");
        System.out.println("sql is at index " + indexSql);
